...
PY_SRC_PATHS = (Path(_) for _ in ("src", "tests", "duties.py", "scripts","src/cocotb_vip_templates"))
...
def check_api(ctx: Context) -> None:
    ...
    # ctx.run(
    #     griffe_check("cocotb_vip_templates", search_paths=["src"], color=True),
    #     title="Checking for API breaking changes",
    #     command="griffe check -ssrc cocotb_vip_templates",
    #     nofail=True,
    # )
